...
{
    /// <inheritdoc />
    public partial class InitialSchoolSystem : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsAcceptingStudents = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PassingGrade = table.Column<int>(type: "int", nullable: false, defaultValue: 50),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DepartmentAnnouncement", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DepartmentAnnouncement_Departments_DepartmentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DepartmentResource", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DepartmentResource_Departments_DepartmentId",
                        column: x => x.DepartmentId,
                        principalTable: "Departments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProfileImagePath = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubjectMaterial", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SubjectMaterial_Subjects_SubjectId",
                        column: x => x.SubjectId,
                        principalTable: "Subjects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QualificationTitle = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InstructorQualification", x => x.Id);
                    table.ForeignKey(
                        name: "FK_InstructorQualification_Instructor_InstructorId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InstructorSchedule", x => x.Id);
                    table.ForeignKey(
                        name: "FK_InstructorSchedule_Instructor_InstructorId",
                        column: x => x.InstructorId,
                        principalSchema: "School",
                        principalTable: "Instructor",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_InstructorSchedule_Subjects_SubjectId",
                        column: x => x.SubjectId,
                        principalTable: "Subjects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DepartmentAnnouncement_DepartmentId",
                schema: "School",
                table: "DepartmentAnnouncement",
                column: "DepartmentId");

            migrationBuilder.CreateIndex(
                name: "IX_DepartmentResource_DepartmentId",
                schema: "School",
                table: "DepartmentResource",
                column: "DepartmentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InstructorQualification_InstructorId",
                schema: "School",
                table: "InstructorQualification",
                column: "InstructorId");

            migrationBuilder.CreateIndex(
                name: "IX_InstructorSchedule_InstructorId",
                schema: "School",
                table: "InstructorSchedule",
                column: "InstructorId");

            migrationBuilder.CreateIndex(
                name: "IX_InstructorSchedule_SubjectId",
                schema: "School",
                table: "InstructorSchedule",
                column: "SubjectId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SubjectMaterial_SubjectId",
                schema: "School",
                table: "SubjectMaterial",
                column: "SubjectId");
